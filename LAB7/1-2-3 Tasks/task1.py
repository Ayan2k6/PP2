...
leftarm = pygame.image.load("PP2/LAB7/images/leftarm.png")
rightarm = pygame.image.load("PP2/LAB7/images/rightarm.png")
mainclock = pygame.transform.scale(pygame.image.load("PP2/LAB7/images/clock.png"), (800, 600))
